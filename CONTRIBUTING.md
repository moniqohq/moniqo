...
Please report suspected security vulnerabilities in private to [support@moniqo.in](mailto:support@moniqo.in). Please do NOT create publicly viewable issues for suspected security vulnerabilities. You can typically expect a response within two business days, and we typically have fixes out in under a week from the initial disclosure.
