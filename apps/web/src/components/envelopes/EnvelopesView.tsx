...
function FilterDropdown({
  ...
  return (
    <div ref={ref} className="relative">
      ...
      {open && (
        <div className="absolute top-full left-0 z-20 mt-1 w-52 overflow-hidden rounded-lg border border-[#1A2640] bg-[#0D1B2E] shadow-lg">
    ...
    <div className="layout-page py-6">
      ...
      <div className="mb-6 grid grid-cols-1 gap-3 sm:grid-cols-2 lg:grid-cols-4">
        ...
        <SummaryCard
          ...
          barColor="#3B82F6"
          barPct={totalAllocated > 0 ? (totalSpent / totalAllocated) * 100 : 0}
        />
        <SummaryCard
          icon={<TrendingUp size={18} />}
          ...
          subColor="#4ADE80"
          barColor="#22C55E"
          barPct={totalAllocated > 0 ? (totalRemaining / totalAllocated) * 100 : 0}
        />
        <SummaryCard
