...
function PasswordCard() {
  ...
  return (
    <div className="overflow-hidden rounded-xl border border-[#1E2B42] bg-[#0F1623]">
      {/* Header */}
      <div className="flex items-center gap-3 border-b border-[#1E2B42] px-5 py-4">
        <div
      ...
      <div className="flex flex-col gap-3 p-5">
        ...
        <div className="flex items-center gap-3">
          <span className="w-[140px] shrink-0 text-[12px] text-[#A8B4CC]">
            Confirm New Password
          </span>
          <PasswordField
            value={confirmPw}
...
const TFA_METHODS = [
  ...
  },
  {
    ...
    description: "Manage recovery email",
    badge: null,
    chevron: true,
  },
  {
    icon: Shield,
    label: "Security Key",
    description: "Add a security key",
    badge: null,
    chevron: true,
  },
];
...
function TwoFactorCard() {
  ...
  return (
    <div className="overflow-hidden rounded-xl border border-[#1E2B42] bg-[#0F1623]">
      {/* Header */}
      <div className="flex items-start gap-3 border-b border-[#1E2B42] px-5 py-4">
        <div
          className="flex h-9 w-9 shrink-0 items-center justify-center rounded-xl"
        ...
        {TFA_METHODS.map((method, i) => {
          ...
          return (
            <button
              key={method.label}
              className={cn(
                "-mx-1 flex w-full items-center gap-3 rounded-lg px-1 py-3.5 text-left transition-all hover:bg-[rgba(255,255,255,0.02)]",
                !last && "border-b border-[#1A2640]",
              )}
            >
              <div className="flex h-8 w-8 shrink-0 items-center justify-center rounded-lg border border-[#1E2B42] bg-[#0D1520]">
              ...
              {method.badge ? (
                <span className="flex items-center gap-1 rounded-full border border-[rgba(34,197,94,0.2)] bg-[rgba(34,197,94,0.12)] px-2 py-1 text-[11px] font-semibold text-[#34D399]">
                  {method.badge}
  ...
  return (
    <div className="overflow-hidden rounded-xl border border-[#1E2B42] bg-[#0F1623]">
      ...
      <div className="flex items-start gap-3 border-b border-[#1E2B42] px-5 py-4">
        ...
        <button className="flex items-center gap-1.5 rounded-lg border border-[rgba(248,113,113,0.2)] px-2 py-1 text-[12px] font-medium text-[#F87171] transition-colors hover:border-[rgba(248,113,113,0.4)] hover:bg-[rgba(248,113,113,0.06)] hover:text-[#FCA5A5]">
          <LogOut size={12} />
          Sign out all
        </button>
      </div>
        ...
        {SESSIONS.map((session, i) => {
          ...
          return (
            <div
              key={session.id}
              className={cn(
                "flex items-center gap-3 px-5 py-3.5 transition-colors hover:bg-[rgba(255,255,255,0.02)]",
                !last && "border-b border-[#1A2640]",
              )}
            >
              {/* Icon + current badge */}
              ...
              {session.isActive ? (
                ...
                <div className="flex shrink-0 items-center gap-2">
                  ...
                  <button className="rounded-lg p-1 text-[#3A4A60] transition-colors hover:bg-[#131C2E] hover:text-[#5A6A85]">
      ...
      <div className="border-t border-[#1E2B42] px-5 py-3">
        <button className="flex items-center gap-1.5 text-[12px] font-medium text-[#6C3AED] transition-colors hover:text-[#A78BFA]">
          View all sessions
  ...
  return (
    <div className="overflow-hidden rounded-xl border border-[#1E2B42] bg-[#0F1623]">
      ...
      <div className="flex items-start gap-3 border-b border-[#1E2B42] px-5 py-4">
        ...
        <button className="flex items-center gap-1.5 rounded-lg border border-[rgba(108,58,237,0.3)] px-2.5 py-1.5 text-[12px] font-medium text-[#A78BFA] transition-colors hover:border-[rgba(108,58,237,0.5)] hover:bg-[rgba(108,58,237,0.1)] hover:text-white">
          <Plus size={12} />
          Add device
        </button>
      </div>
            ...
            >
              ...
              <div className="min-w-0 flex-1">
                <div className="flex items-center gap-2">
                  ...
                  {device.isCurrent && (
                    <span className="rounded-sm border border-[rgba(108,58,237,0.3)] bg-[rgba(108,58,237,0.15)] px-1.5 py-0.5 text-[9px] font-bold text-[#A78BFA]">
                      This Device
                    </span>
                  )}
                </div>
                <p className="mt-0.5 text-[11px] text-[#5A6A85]">{device.detail}</p>
              </div>
              <div className="flex shrink-0 items-center gap-2">
      ...
      {/* Info footer */}
      <div className="flex items-center gap-2 border-t border-[#1E2B42] px-5 py-3">
        <Info size={12} className="shrink-0 text-[#60A5FA]" />
        <p className="text-[11px] text-[#5A6A85]">
          Remove a device if you no longer use it or if it&apos;s not recognizable.
        </p>
      </div>
    </div>
  );
...
function SecurityStatusBadge() {
  return (
    <div className="flex items-center gap-3 rounded-xl border border-[#1E2B42] bg-[#0F1623] px-4 py-3 transition-colors hover:border-[#2A3A54]">
      <div
