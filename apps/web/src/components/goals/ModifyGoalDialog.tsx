...
function SectionTitle({ num, title }: { num: number; title: string }) {
  return (
    <div className="flex items-center gap-2.5">
      <div
        className="flex h-6 w-6 flex-shrink-0 items-center justify-center rounded-lg text-[12px] font-bold text-white"
        ...
        {selected ? (
          <>
            ...
            <button
              ...
              className="flex-shrink-0 text-[#5A6A85] transition-colors hover:text-white"
            >
              <X size={13} />
            </button>
          </>
          ...
          <>
            <Search size={13} className="flex-shrink-0 text-[#3A4A62]" />
            <span className="flex-1 text-[#3A4A62]">Search or select envelope</span>
          </>
        )}
        <ChevronDown size={13} className="flex-shrink-0 text-[#3A4A62]" />
      </button>
        ...
        <>
          ...
          <div className="pointer-events-none fixed inset-0 z-[210] flex items-center justify-center p-4">
            <motion.div
              ...
              className="pointer-events-auto relative w-full max-w-md overflow-hidden rounded-2xl border border-[#1A2540] bg-[#0B1120]"
            ...
            >
              ...
              <div className="p-6">
                <div className="mb-5 flex items-start gap-4">
                  <div className="flex h-11 w-11 flex-shrink-0 items-center justify-center rounded-xl border border-[#F59E0B]/20 bg-[rgba(245,158,11,0.12)]">
                ...
                <div className="mb-5 flex items-start gap-2.5 rounded-xl border border-[#1E2B42] bg-[#0D1525] p-3.5">
                  <Archive size={14} className="mt-0.5 flex-shrink-0 text-[#F59E0B]" />
                  <p className="text-[12px] leading-relaxed text-[#A8B4CC]">
                    Historical contributions and reporting data will be preserved. You can unarchive
                    this goal at any time.
                  </p>
                </div>
                ...
                <div className="flex gap-3">
                  <button
                    type="button"
                    onClick={onClose}
                    className="h-10 flex-1 rounded-xl border border-[#1E2B42] bg-[#0D1525] text-[13px] text-[#7A8BA8] transition-all hover:border-[#3A4A62] hover:text-white"
                  >
                    Cancel
                  </button>
                  <button
                    type="button"
                    onClick={onConfirm}
                    className="flex h-10 flex-1 items-center justify-center gap-2 rounded-xl border border-[#F59E0B]/30 bg-[rgba(245,158,11,0.1)] text-[13px] font-medium text-[#F59E0B] transition-all hover:bg-[rgba(245,158,11,0.18)]"
                  >
                    <Archive size={13} />
                    Archive Goal
                  </button>
...
export function ModifyGoalDialog({
  open,
  goal,
  onClose,
  onSave,
  onArchive,
}: ModifyGoalDialogProps) {
  // ── Section 1 ──
  ...
  useEffect(() => {
    ...
    const handler = (e: KeyboardEvent) => {
      if (e.key === "Escape" && !archiveOpen) onClose();
    };
                ...
                <div className="relative flex items-start justify-between border-b border-[#111B2D] px-7 pt-6 pb-5">
                  <div>
                    ...
                    <p className="mt-1 text-[14px] text-[#4A5A75]">
                      Update your goal details and stay on track
                    </p>
                  </div>
                ...
                <div className="flex items-center justify-between border-t border-[#111B2D] bg-[#080C14] px-7 py-4">
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <button
                      ...
                      className="flex h-10 items-center gap-2 rounded-xl border border-[#1E2B42] bg-[#0D1525] px-4 text-[13px] font-medium text-[#A8B4CC] transition-all hover:border-[#F59E0B]/30 hover:bg-[rgba(245,158,11,0.06)] hover:text-[#F59E0B]"
                    >
                      <Archive size={14} />
                      Archive Goal
                    </button>
