  ...
  return (
    <div className="relative">
      <input
        ...
        className={cn(
          "h-11 w-full appearance-none rounded-xl border bg-[#0D1525] pr-10 pl-3 text-sm text-white transition-all focus:outline-none",
          "[color-scheme:dark]",
          error
            ? "border-[#F87171]/60 ring-2 ring-[#F87171]/20"
            ...
            >
              ...
              <div className="flex items-center justify-between border-t border-[#111B2D] bg-[#080C14] px-7 py-4">
                ...
                <motion.button
                  ...
                  className="flex h-10 items-center gap-2 rounded-xl px-7 text-[13.5px] font-semibold text-white transition-all focus:ring-2 focus:ring-[#6C3AED]/50 focus:outline-none"
                  style={{
