...
export function ReportDateRangePicker({ from, to, onChange }: Props) {
  ...
  return (
    <div ref={ref} className="relative">
      ...
      {open && (
        <div className="absolute right-0 top-full mt-1.5 z-40 w-52 rounded-xl border border-[#1E2B42] bg-[#0D1623] shadow-2xl py-1.5 overflow-hidden">
          {presets.map(p => {
            ...
            return (
              <button
                ...
                className={cn(
                  ...
                  active
                    ? 'text-[#C4B5FD] bg-[rgba(108,58,237,0.12)]'
